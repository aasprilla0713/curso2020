...
import ShowDetalleBuy from "../../components/Coincidences/ShowDetalleBuy";

const screenWidth = Dimensions.get("window").width;

export default function MatchOferta(props) {
  ...
  return (
    <View style={styles.ViewEstateTitle}>
      <ListItem
        ...
        title={matchesOrder.solicitante}
        subtitle={matchesOrder.mail_solicitante}
        bottomDivider
        chevron
