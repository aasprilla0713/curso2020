...
export default function AddOfferGenForm(props) {
  const {
    toastRef,
    setIsLoading,
    navigation,
  ...
  const [precioEstate, setPrecioEstate] = useState(0);
  ...
  const [precioFinal, setPrecioFinal] = useState(100);
      ...
      <View style={styles.viewFormMedia}>
        ...
        <View style={{ flex: 0.5 }}>
          <Input
            ...
            onChange={(e) => setPrecioEstate(e.nativeEvent.text)}
          />
        </View>
      </View>
      <Input
