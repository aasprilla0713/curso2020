...
export default function AddOrderForm(props) {
  ...
  const [precioMedio, setPrecioMedio] = useState(brokerhood.bkh_medio);
  const [curInicial, setCurInicial] = useState(brokerhood.bkh_minimo);
  const [curFinal, setCurFinal] = useState(brokerhood.bkh_maximo);
...
function FormAdd(props) {
  ...
  return (
    <View style={styles.viewForm}>
      ...
      >
        <Text>$ {curInicial} M</Text>
        <Text>Precio Entre</Text>
        <Text>$ {curFinal} M</Text>
      </View>
      <Slider
        style={{
          height: 10,
        ...
        maximumValue={curFinal}
        step={10}
        value={curInicial}
        onValueChange={(value) => setCurInicial(value)}
      ...
      <Slider
        ...
        minimumValue={curInicial}
        maximumValue={precioFinal}
        step={10}
        onValueChange={(value) => setCurFinal(value)}
        value={curFinal}
        minimumTrackTintColor={CST.colorSec}
        maximumTrackTintColor={CST.colorPrm}
      />
      <View
        style={{
          marginHorizontal: 15,
