...
export default function ShowDetalleBrk(props) {
  ...
  const menuOption = [
    {
      title: matchesOrder.oferente.substr(0, 30),
      subtitle: matchesOrder.mail_oferente.substr(0, 30),
    ...
    {
      title: matchesOrder.company_oferente.substr(0, 25),
      subtitle: matchesOrder.cargo_oferente.substr(0, 25),
      iconType: "material-community",
    ...
    {
      title: "Ofertas (" + matchesOrder.ofertas_vnd + ") ",
      subtitle: null,
      iconType: "material-community",
    ...
    {
      title: "Peticiones (" + matchesOrder.pedidos_vnd + ")",
      subtitle: null,
      iconType: "material-community",
    ...
    {
      title: "Broker Hits (" + matchesOrder.hits_vnd + ")",
      subtitle: null,
      iconType: "material-community",
    ...
    {
      title: "Broker Catches (" + matchesOrder.catches_vnd + ")",
      subtitle: null,
      iconType: "material-community",
      iconNameLeft: "hand",
